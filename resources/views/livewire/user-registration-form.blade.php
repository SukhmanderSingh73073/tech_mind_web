        ...
        <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <x-adminlte-input readonly id="school_name" name="school_nae" label="School Name"
                        placeholder="School Code" fgroup-class="col-md-10" value="school Name" enable-old-support />
                </div>
