...
<div class="row">
    ...
    <x-adminlte-input name="first_name" label="Name" placeholder="{{ $role }}'s name" fgroup-class="col-md-3" enable-old-support value="{{ $user->name }}" />
    ...
    <x-adminlte-input value="{{ $user->email }}" readonly="true" name="email" type="email" label="Email address *" placeholder="Enter {{ $role }}'s email address" fgroup-class="col-md-3" enable-old-support />
    <x-adminlte-input name="" label=" Password *" placeholder="input a password" readonly="true" fgroup-class="col-md-3" type="password" />
    <x-adminlte-input value="{{ $user->password_confirmation }}" name="" readonly="true" label="Confirm password *" placeholder="input password again" fgroup-class="col-md-3" type="password" />
    ...
    <div class="row">
        ...
        <x-adminlte-input name="sr_no" value="{{ $studentRecord->sr_no }}" label="Unique ID*" placeholder="Unique ID" fgroup-class="col-md-3" enable-old-support autocomplete="off" />
        <x-adminlte-input name="roll_no" value="{{ $studentRecord->roll_no }}" label="Roll number *" placeholder="Student's Roll number" fgroup-class="col-md-3" enable-old-support autocomplete="off" />
        ...
        <x-adminlte-input value="{{ $studentRecord->admission_date }}" name="admission_date" label="Admission number *" placeholder="Student's admission number" fgroup-class="col-md-3" enable-old-support autocomplete="off" />
        <x-adminlte-input-date value="{{ $studentRecord->admission_date }}" name="admission_date" id="admission_date" :config="['format' => 'YYYY/MM/DD']" placeholder="Choose student's admission date..." label="Date of admission" fgroup-class="col-md-3" autocomplete="off" />
        @csrf
    </div>
    @endrole
