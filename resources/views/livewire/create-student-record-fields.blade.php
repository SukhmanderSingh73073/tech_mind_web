<div class="row">
    ...
    <x-adminlte-input-date name="admission_date" :config="['format' => 'YYYY/MM/DD']" placeholder="Choose student's admission date..." label="Date of admission"  fgroup-class="col-md-3" value="{{old('admission_date')}}"  autocomplete="off"/>
