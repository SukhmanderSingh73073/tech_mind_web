<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('account-applications.update', $applicant->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <x-adminlte-select name="role_id"  enable-old-support class="text-capitalize d-none">    
            ...
            <div class='col-12 my-2'>
                <x-adminlte-button label="Save" theme="primary" icon="fas fa-key" type="submit" class="col-md-3"/>
            </div>
        </form>
    </div>
</div>
